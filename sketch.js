...
function draw(){
  ...
  // stoping the ground
    ...
    // stoping the clouds and the obstacles
    obstaclesGroup.setVelocityXEach(0)
    cloudsGroup.setVelocityXEach(0)
    
    //chaning the animation of trex to dead 
  ...
  // making trex collide with the ground so that it doesnt fall through the ground
...
function spawnClouds(){ 
  // checking if the frameCount is a multiple of 60 to make sure that my clouds are only displayed in those frames that are divisible by 60 because i dont want a cloud to be display in every single frame because they overlap eachother when display in every single frame  
  if (frameCount%60==0){
